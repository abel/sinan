...
{
    public static partial class NumberRandom
    {
        [ThreadStatic]
        ...
        static public int Next(this int maxValue)
        {
            return random.Next(maxValue);
        }

        static public int Next(this int minValue, int maxValue)
        {
        ...
        /// <returns></returns>
        public static bool RandomHit(this double m)
        {
