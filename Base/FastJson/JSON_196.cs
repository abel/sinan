...
namespace Sinan.FastJson
{
    ...
    public class JSON
    {
        ...
        public object Parse<T>(string json) where T : class,IDictionary<string, object>, new()
        {
            return JsonDecoder<T>.DeserializeDictionary(json);
        ...
        {
            Dictionary<string, object> ht = JsonDecoder<Dictionary<string, object>>.DeserializeDictionary(json);
        ...
        private object FastCreateInstance(Type objtype)
        {
            ...
            {
                throw new JsonException(string.Format("Failed to fast create instance for type '{0}' from assemebly '{1}'",
        ...
        private object ParseDictionary(Dictionary<string, object> d, Dictionary<string, object> globaltypes, Type type)
        {
            ...
            if (type == null)
            {
                throw new JsonException("Cannot determine type");
            }
